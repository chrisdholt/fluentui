...
export const ButtonAppearance = renderComponent(html<ButtonStoryArgs>`
...
export const ButtonShape = renderComponent(html<ButtonStoryArgs>`
...
export const ButtonSize = renderComponent(html<ButtonStoryArgs>`
...
export const ButtonDisabled = renderComponent(html<ButtonStoryArgs>`
  <fluent-button>Enabled State</fluent-button>
  <fluent-button disabled>Disabled State</fluent-button>
  <fluent-button disabledfocusable>Disabled Focusable</fluent-button>
  <fluent-button appearance="primary">Enabled State</fluent-button>
  <fluent-button disabled appearance="primary">Disabled State</fluent-button>
  <fluent-button disabledfocusable appearance="primary">Disabled Focusable</fluent-button>
`);

export const ButtonWithIconStart = renderComponent(html<ButtonStoryArgs>`
...
export const ButtonWithIconEnd = renderComponent(html<ButtonStoryArgs>`
  <fluent-button size="small"
    ><svg
      fill="currentColor"
      slot="end"
...
export const ButtonWithIconOnly = renderComponent(html<ButtonStoryArgs>`
  <fluent-button size="small"
    ><svg
      fill="currentColor"
      aria-hidden="true"
...
export const ButtonWithLongText = renderComponent(html<ButtonStoryArgs>`
  <fluent-button>Short text</fluent-button>
  <fluent-button>Long text wraps after it hits the max width of the component</fluent-button>
`);
